    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          <p className="font-display font-semibold text-sm" style={{ color: "var(--star-white)" }}>
            {personalInfo.name}
          </p>
        ...
        <motion.button
          onClick={scrollToTop}
          className="group flex items-center gap-2 text-xs font-mono px-3 py-2 rounded-lg transition-all duration-300 hover:bg-white/5"
          style={{ color: "var(--text-muted)" }}
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.95 }}
        >
